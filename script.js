...
const data = {
    creators: [
        { title: "Selam", sub: "476 Followers", img: "https://i.postimg.cc/xCgYV8j4/blackteensubmit-model-1.jpg", isOnline: true },
        { title: "Hellen", sub: "4.3k Followers", img: "https://i.postimg.cc/Y98kB02V/c0925a4a731a3be6d8a120c0e265bb3f.jpg", isOnline: false },
        { title: "Rahel", sub: "1k Followers", img: "https://i.postimg.cc/BnvSSxP6/1788172128809.jpg", isOnline: true },
        { title: "Bethlehem", sub: "3k Followers", img: "https://i.postimg.cc/wBy9JgV3/1788171869754.jpg", isOnline: true },
        { title: "Eden", sub: "700 Followers", img: "https://i.postimg.cc/vTzyMBQP/1788171877524.jpg", isOnline: false },
        ...
        { title: "Frehiwot", sub: "7.5k Followers", img: "https://i.postimg.cc/9M1VH0Xk/xn-9-t.jpg", isOnline: true },
    ...
    channels: [
        { title: "ሀበሻ Hub VIP", sub: "3.7k Members", img: "https://i.postimg.cc/9QZNRfRq/images-(32).jpg" },
        { title: "VIP Lounge", sub: "8.4k Members", img: "https://i.postimg.cc/wjLbyByL/IMG-20260831-143309-695.jpg" },
        { title: "Exclusive Club", sub: "15.1k Members", img: "https://i.postimg.cc/hPH5tmjm/20d635a5782a514b7390c0f82424bf89.jpg" },
        { title: "Models Corner", sub: "6.3k Members", img: "https://i.postimg.cc/BQdVnF6Q/channels4-profile.jpg" },
        { title: "Habesha Trends", sub: "22k Members", img: "https://i.postimg.cc/y8crgNgx/9daa102d9a1f1d3ea38336a388375d0c-fgraphic.png" },
        { title: "Live Updates", sub: "6.8k Members", img: "https://i.postimg.cc/HkXPcLc9/90841542-009-9700.jpg" },
        { title: "Music & Vibe", sub: "11.4k Members", img: "https://i.postimg.cc/gkfT2hJ0/attachment-107066830.png" },
        { title: "Chat Room", sub: "7.9k Members", img: "https://i.postimg.cc/y8crgNgd/hot-sexy-woman-female-lady-legs-with-high-heels-for-bar-strip-club-logo-design-vector.jpg" },
        { title: "Private Streams", sub: "14.2k Members", img: "https://i.postimg.cc/sg70Q2Qg/sexy-high-heels-with-g-string-for-bar-strip-club-logo-design-vector.jpg" },
        { title: "Habesha Chill", sub: "5.5k Members", img: "https://i.postimg.cc/rwxY0p0W/black-anal-beauties-skin-diamond-close-up.jpg" },
        { title: "Creators Circle", sub: "18.6k Members", img: "https://i.postimg.cc/hPH5tmjt/2251727-4742.png" },
        { title: "Fashion Hub", sub: "10.1k Members", img: "https://i.postimg.cc/JzZdDhD4/the-Rolling-Stones-Tongue-and-Lips-logo.jpg" },
        { title: "Weekly Highlights", sub: "8.9k Members", img: "https://i.postimg.cc/yYwb8Rdx/logo-square.jpg" },
        { title: "Addis Nightlife", sub: "13.7k Members", img: "https://i.postimg.cc/GhZ5mD22/images-(35).jpg" },
        { title: "VIP Backstage", sub: "4.9k Members", img: "https://i.postimg.cc/MpVrMGMv/images-(34).jpg" },
        { title: "Influencers ET", sub: "16.2k Members", img: "https://i.postimg.cc/gkfT2hJz/images-(36).jpg" },
        { title: "Habesha Media", sub: "9.1k Members", img: "https://i.postimg.cc/qM95vKR4/images-(2).png" },
        { title: "Global Habesha", sub: "25.4k Members", img: "https://i.postimg.cc/13wYnzn8/images-(1).png" },
        { title: "Showcase Hub", sub: "11.8k Members", img: "https://i.postimg.cc/4NrSxcdX/images-(3).png" },
        { title: "VIP Gold Members", sub: "8.7k Members", img: "https://i.postimg.cc/jdGFSf57/a628b8f187893999fd7903c7a729945a.jpg" }
    ],
    videos: [
        { title: "Exclusive Vlog #1", sub: "14K Views • 12 mins", img: "https://i.postimg.cc/QCb9F1gC/1.webp" },
        { title: "Behind The Scenes", sub: "23K Views • 18 mins", img: "https://i.postimg.cc/FzZdY3bv/1-460.jpg" },
        { title: "Model Photoshoot Highlights", sub: "8K Views • 9 mins", img: "https://i.postimg.cc/cCmgvw71/1280x720-17339428.webp" },
        { title: "Addis Fashion Week", sub: "3K Views • 24 mins", img: "https://i.postimg.cc/Y0G3vYN9/2560x1440-204.webp" },
        { title: "Special Interview", sub: "9K Views • 7 mins", img: "https://i.postimg.cc/kGc62KNg/6293659-90499e3-320x.jpg" },
        { title: "Summer Vlog", sub: "5K Views • 45 mins", img: "https://i.postimg.cc/NF49Km8m/alia-starr-8.jpg" },
        { title: "Live Concert Clip", sub: "7K Views • 15 mins", img: "https://i.postimg.cc/L5Rg4NPs/images-(38).jpg" },
        { title: "Model Showcase", sub: "19K Views • 32 mins", img: "https://i.postimg.cc/SRqYQD9Q/images-(39).jpg" },
        { title: "VIP Exclusive Cut", sub: "20K Views • 14 mins", img: "https://i.postimg.cc/Y0kL2bFt/images-(40).jpg" },
        { title: "Travel Vlog Ethiopia", sub: "4K Views • 5 mins", img: "https://i.postimg.cc/WzjqpXZj/images-(41).jpg" },
        { title: "Music Video Teaser", sub: "6K Views • 21 mins", img: "https://i.postimg.cc/NFY2GpXc/images-(42).jpg" },
        { title: "Studio Session", sub: "15K Views • 11 mins", img: "https://i.postimg.cc/mkR1Z894/images-(43).jpg" },
        { title: "Dance Performance", sub: "3K Views • 16 mins", img: "https://i.postimg.cc/GtQ84GPy/IMG-20260831-151829-206.jpg" },
        { title: "Red Carpet Highlights", sub: "12K Views • 50 mins", img: "https://i.postimg.cc/8cHJ7Mdr/IMG-20260831-151841-788.jpg" },
        { title: "Life in Addis", sub: "3K Views • 19 mins", img: "https://i.postimg.cc/WznFdgms/Lily-Starfire-Big-Boobie-Babe-In-Hot-Red-Bikini-All-Black-X8.jpg" },
        { title: "Creator Spotlight", sub: "4K Views • 10 mins", img: "https://i.postimg.cc/7hVG501b/preview-mp4.jpg" },
        { title: "Q&A Session", sub: "8K Views • 4 mins", img: "https://i.postimg.cc/6q028nV4/xn-30-p.jpg" },
        { title: "Behind the Lens", sub: "2K Views • 28 mins", img: "https://i.postimg.cc/BbgLjH5f/xn-30-t.jpg" },
        { title: "VIP Sneak Peek", sub: "13K Views • 13 mins", img: "https://i.postimg.cc/6q028nV2/xv-30-p.jpg" },
        { title: "Bonus Footage", sub: "18K Views • 22 mins", img: "https://i.postimg.cc/QCb9F1gC/1.webp" }
    ],
    streams: [
...
// ==========================================
// 5. CHAT SYSTEM (NO STORIES, NO NAMES, UNREAD DETECTOR)
// ==========================================
function initCustomChatList() {
    ...
    chatContainer.innerHTML = `
        <div id="chatWrapper" style="background:#000; color:#fff; min-height:100vh; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width:480px; margin:0 auto; display:flex; flex-direction:column;">
            
            <div style="display:flex; justify-content:space-between; align-items:center; padding:16px; border-bottom:1px solid #1a1a1a;">
            ...
            <div id="chatRowsContainer" style="flex:1; overflow-y:auto;"></div>

            <div id="singleRoomView" style="display:none; flex-direction:column; height:100vh; background:#000; position:fixed; top:0; left:0; right:0; bottom:0; z-index:9999; max-width:480px; margin:0 auto;">
                <div id="singleRoomHeader" style="display:flex; align-items:center; gap:12px; padding:12px 16px; border-bottom:1px solid #1a1a1a;"></div>
                <div id="singleRoomMessages" style="flex:1; padding:16px; overflow-y:auto; display:flex; flex-direction:column; gap:10px;"></div>
                <div style="padding:12px 16px; display:flex; align-items:center; gap:10px; border-top:1px solid #1a1a1a;">
                    <input type="text" id="customChatInput" placeholder="Message..." style="flex:1; background:#121212; border:1px solid #262626; color:#fff; padding:10px 16px; border-radius:22px; font-size:0.9rem; outline:none;">
                    <button onclick="sendCustomMessage()" style="background:none; border:none; color:#0095f6; font-weight:bold; font-size:0.95rem; cursor:pointer;">Send</button>
                </div>
            </div>
        </div>
    `;
...
function renderRoomMessages(chat) {
    ...
    chat.messages.forEach(m => {
        ...
        wrapper.style.cssText = `display:flex; flex-direction:column; align-items:${isSent ? 'flex-end' : 'flex-start'};`;

        const bubble = document.createElement('div');
        bubble.style.cssText = isSent ?
            "background:#3797f0; color:#fff; padding:10px 14px; border-radius:18px 18px 4px 18px; max-width:75%; font-size:0.9rem;" :
            "background:#262626; color:#fff; padding:10px 14px; border-radius:18px 18px 18px 4px; max-width:75%; font-size:0.9rem;";
